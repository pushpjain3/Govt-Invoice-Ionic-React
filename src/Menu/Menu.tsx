...
const Menu: React.FC<{
  ...
  const sendEmail = () => {
    ...
    const filename = 'new_data.csv'; // Specify the desired filename
    ...
    if (isPlatform("hybrid")) {
      ...
      reader.onload = function () {
        ...
        if (typeof result === 'string') {
          // Extract the base64 part if the result is a string
          ...
          emailComposer.open({
            ...
            attachments: [`base64:${filename}//${base64Data}`], // Attach the base64 data
            subject: "Test mail",
    ...
    // else {
    //   const API_KEY = '43f0d80f540060b8381ad9c29aea087a-413e373c-67e2c210';
    //   const DOMAIN = 'sandbox00a9a9c0f3374be49c44897669f495b2.mailgun.org';
